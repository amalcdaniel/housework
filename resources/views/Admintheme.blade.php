    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li class="dropdown"><a href="#"><span>View</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            <li class="dropdown"><a href="#"><span>View Workers</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="/adminviewworkerp#worker">View Workers Personal info</a></li>
                  <li><a href="/adminviewworkero#worker">View Workers Official info</a></li>
                  </ul>
                  </li>
              <li><a href="\viewfeedback#feedback">View Feedback</a></li>
              <li><a href="\adminviewcat#categories">View Categories</a></li>
              <li><a href="\adminviewsubcat#categories">View Sub Categories</a></li>
              <li><a href="\adminviewcustomer#customer">View Customers</a></li>
              <li><a href="\adminviewloc#location">View Locations</a></li>
              <li><a href="\messages#customer">View Messages</a></li>
              <li><a href="\adminviewbookings#booking">View Bookings</a></li>
            </ul>
          </li>

          <li class="dropdown"><a href="#"><span>Add</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="/categoryaddworker#worker">Add Worker</a></li>
              <li><a href="/adminhome#location">Add Location</a></li>
              <li><a href="/adminhome#category">Add Category</a></li>
              <li><a href="/adminhome#subcategory">Add Sub Category</a></li>
          ...
          <li class="dropdown"><a href="#"><span>My Account</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            <li><a href="/viewbookreport">Report Zone</a></li>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>HousWork</h1>
          <h2>Providing Perfect Solutions<span>.</span></h2>
        </div>
      </div>
