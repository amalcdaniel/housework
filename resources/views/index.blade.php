...
<body>
  ...
  <main id="main">
   ...
   <!-- ======= About Section ======= -->
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="\pservice#portfolio">Plumbing Service</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch "  data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="\eservice#portfolio">Electricial Services</a></h4>
    ...
    <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
          ...
          <h2 style="color:white;" class="nav-link scrollto">Various Problems<span>.</span> One Destination<span>.</span></h2>
        </div>
        ...
        <h1 style="color:white; margin-top:100px;" class="nav-link scrollto">Connect with Us<span>.</span></h1>
        ...
        @if(Session::get('fail'))
            ...
            @endif
        {{csrf_field()}}
        <table class="table table-borderless" style="width:10px; margin-top:150px; margin-bottom:100px;">
    <tr>
        <td>
        <input type="email" class="form-control" placeholder=" User Name" name="uname" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
        </td>
    </tr>
    ...
    <tr>
    <td>
    <button class="cta-btn" style="width:550px; height:50px; opacity:0.5;">Log In</button>
    </td>
    </tr>
    </table>
    </form>
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>SIGN UP</h2>
          <p>TO BECOME OUR FAMILY MEMBER</p>
        </div>
    ...
    <tr>
        <td>
        <input type="email" class="form-control" placeholder="Email" name="Email"  value="{{ old('Email') }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
        </td>
        <tr>
    ...
    <tr>
        <td>
        <input type="tel" class="form-control"placeholder="Mobile No" name="mob" pattern=".{10}" title="10 digits required" required>
        </td>
    </tr>
    
    <tr>
        <td>
        <input type="password" class="form-control" placeholder="Password" name="pass"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" required></td>
    ...
    <tr>
    <td>
    <button class="btn btn-dark" style="width:1250px; height:70px;">Sign up</button>
    </td>
    </tr>
    </table>
    </form>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <form action="messageread" method="post" role="form" >
        {{csrf_field()}}
              <div class="row">
              ...
              <div class="form-group mt-3">
       <textarea name="message"  cols="30" rows="10" class="form-control" placeholder="Enter your message here" required ></textarea>
