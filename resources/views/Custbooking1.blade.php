            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3" style="background: rgba(0,0,0,0.9); opacity:0.95;">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        ...
                        <form id="msform" action="booking2" method="post">
                        {{csrf_field()}}
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <div class="form-card">
                                    <h2 class="fs-title" style="color:skyblue;" >Fix your Problem</h2> 
                            <table class="table table-borderless ">
                            <input type="hidden" class="form-control" name="ida" style="background-color:#595858; color:white;" value="{{$lastinsertedid}}">
                            <tr>
                            <td><strong style="color:white;">Select worker :</strong>
                            <select name="worker" id="name" class="form-control" style="background-color:#595858; color:white;" required>
                            ...
                            <tr>
                            <td>
                            <strong style="color:white;">Select your Component :</strong>
                            <select name="subcategory" id="subcategory" class="form-control" style="background-color:#595858; color:white;" required>
                            ...
                            <input type="date" name="date" class="form-control" style="background-color:#595858; color:white;">
                            </td>
                            </tr>
                            <tr>
                            <td><span class="text-danger">@error('date'){{ $message }} @enderror</span></td>
                            </tr>
                            <tr>
                            <td><strong style="color:white;">Select Time :</strong> 
                            <select name="time" class="form-control" style="background-color:#595858; color:white;" required>
