    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="\custviewbooks">My Bookings</a></li>
          <li><a class="nav-link scrollto" href="\home#services">Services</a></li>
          <li><a class="nav-link scrollto" href="\customerfeedback">Feedback</a></li>
          <li class="dropdown"><a href="#"><span>My Account</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="\home#team">My Profile</a></li>
...
<tr>
    ...
    <td><button class="btn btn-dark">Confirm</button></td>
          ...
          <li><a class="nav-link scrollto" href="\viewteam#workers">Worker Details</a></li>

   
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->

      <a href="\custbook" class="get-started-btn scrollto">BOOK NOW</a>
