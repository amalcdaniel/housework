            ...
            <div class="col-md-4 mb-3">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ URL::asset('assets/worker_img/'.$data['Filepath']) }}" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>{{ $data['Fname'] }}</h4>
                      <p class="text-secondary mb-1">Worker</p>
                      <p class="text-muted font-size-sm">HousWork</p>
              ...
              <div class="card mt-3">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">Customer : </h6>  <span class="text-secondary">{{$activebooking->customer->Fname}} {{$activebooking->customer->Lname}}</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">Customer Location : </h6>  <span class="text-secondary">{{$activebooking->customer->Hno}},{{$activebooking->customer->Street}},{{$activebooking->customer->City}},{{$activebooking->customer->Pincode}}</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">Customer Contact no : </h6>  <span class="text-secondary">{{$activebooking->customer->Mob}}</span>
                  </li>
                </ul>
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <div  style="height: 5px">
                              ...
                              <small>Customer : {{$futurebooking->customer->Fname}} {{$futurebooking->customer->Lname}}</small>
                      <div  style="height: 5px">
                              </div>
                              <small>Customer Location : {{$futurebooking->customer->Hno}},{{$futurebooking->customer->Street}},{{$futurebooking->customer->City}},{{$futurebooking->customer->Pincode}}</small>
                      <div  style="height: 5px">
                              </div>
                              <small>Customer Contact no : {{$futurebooking->customer->Mob}}</small>
                      <div  style="height: 5px">
                              </div>
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <div  style="height: 5px">
                              ...
                              <small>Customer : {{$booking->customer->Fname}} {{$booking->customer->Lname}}</small>
                      <div  style="height: 5px">
                              </div>
                              <small>Customer Location : {{$booking->customer->Hno}},{{$booking->customer->Street}},{{$booking->customer->City}},{{$booking->customer->Pincode}}</small>
                      <div  style="height: 5px">
                              </div>
                              <small>Customer Contact no : {{$booking->customer->Mob}}</small>
                      <div  style="height: 5px">
                              </div>
