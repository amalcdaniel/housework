...
<body style="    background-image:url('https://wallpapercave.com/wp/vhgYQou.jpg');  ">

 <!-- ======= Header ======= -->
 <header id="header" class="fixed-top " style="background-color:black;">
    <div class="container d-flex align-items-center justify-content-lg-between" >

      <h1 class="logo me-auto me-lg-0"> <img src="assets/img/logo.png"><a href="\home">HousWork <span></span></a></h1>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" >
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card" style="background: rgba(0,0,0,0.9); opacity: 0.75;">
                                <div class="card-body text-center"> 
                                    <p><img class=" img-fluid" src="{{ URL::asset('assets/worker_img/'.$worker->Filepath) }}">    </p>
                                    <h4 class="card-title">{{$worker->Fname}} {{$worker->Lname}}</h4>
                                    <p class="card-text"><storng>{{$worker->Wtype}}</strong></p>
