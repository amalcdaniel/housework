...
body {
	color: #fff;
	 /* The image used */
	 background-image: url('https://wallpaperaccess.com/full/1867010.jpg');
...
<form action="/locationeditprocess/{{ $locationview->id }}" method="post">
                  {{csrf_field()}}
		<h2 style="color:white;">Change Location<span style="color:white;">.</span></h2>
		<p>Location id : {{$locationview->id}}</p>
		<hr>
        <div class="form-group">
        <input type="text" class="form-control" name="location"  style="background-color:#595858; color:white;" value="{{$locationview->Location}}" required >
                    
        </div>
        <div class="form-group">
            <button type="submit" style="color:black;" class="btn btn-primary btn-block btn-lg">Update location</button>
        </div>
		<div class="form-group">
             </div>
		...
		<div class="modal-content">
			<form>
				...
				<div class="modal-footer" style="background-color:white;">
					...
					<a href="/adminviewloc#location"><input class="btn btn-danger"style="color:black;" value="Confirm"></a>
				</div>
			</form>
		</div>
	</div>
